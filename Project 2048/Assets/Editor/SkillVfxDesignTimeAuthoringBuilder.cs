    ...
    public static class SkillVfxDesignTimeAuthoringBuilder
    {
        ...
        private static Dictionary<string, ParticleSystem> CreateNamedParticlePrefabs()
        {
            var bindings = new Dictionary<string, ParticleSystem>
            {
                ...
                ["BleedingCutBloodFountain"] = CreateParticlePrefab("SkillVfx_BleedingCutBloodFountain", LoadMaterial(Materials + "/SkillVfx_BloodFountainSlash.mat"), 1.15f, 0.95f, false),
                ["BleedingCutBloodMist"] = CreateParticlePrefab("SkillVfx_BleedingCutBloodMist", LoadMaterial(Materials + "/SkillVfx_BloodFountainSlash.mat"), 1.35f, 1.05f, false),
